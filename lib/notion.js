...
export async function saveToNotion(parsedData) {
    ...
    children.push({
        ...
        callout: {
            rich_text: [{ text: { content: unescapeNewlines(article.intro || '') } }],
    ...
    children.push({ object: 'block', type: 'quote', quote: { rich_text: [{ text: { content: unescapeNewlines(article.editor_comment || '') } }] } });
