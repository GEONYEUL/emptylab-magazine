...
export async function step_review(articleData, originalFacts) {
    ...
    if (!isNonEmpty(cardNews) && isNonEmpty(originalCardNews)) {
    ...
    if (!isNonEmpty(slackSummary) && isNonEmpty(originalSlackSummary)) {
    ...
    if (!isNonEmpty(hashtags) && isNonEmpty(originalHashtags)) {
